...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($email) || empty($new_password)) {
        ...
        header("Location: reset_password.php?status=invalid_input");
        exit;
    }
    ...
    if (!$stmt) {
        ...
        header("Location: reset_password.php?status=stmt_error");
        exit;
    }
    ...
    if ($stmt->execute()) {
        ...
        header("Location: reset_password.php?status=update_error");
        exit;
    }
